...
from Utiles import evaluarPrimeraRestriccion, generar_matriz, productoEscalar2Matrices, productoEscalar3Matrices
...
Xij_inicial = crear_matriz_ceros(matriz_A)
